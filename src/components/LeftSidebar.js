...
const LeftSidebar = () => {
    return (
        <div className="flex flex-col items-center justify-between pl-4 pr-2 h-max bg-gray-200 rounded-md">
            <div className="flex items-center mb-20 pt-4 cursor-pointer">
                <img
                    src={logo}
                    alt="Skilify Admin"
            ...
            <nav className="flex flex-col space-y-2 pb-6"> 
                <div className="nav-link transition duration-1000 hover:bg-gray-800 p-4 rounded-3xl w-60 flex items-center justify-between pl-8 pr-8">
                    <span>
            ...
            <div className="bg-slate-300 rounded-2xl mb-6 mt-8 w-full">
